export const dataService = [
  ...
  }, 
  {
    ...
    descriptionLong2: 'En primer lugar, nuestra guía te enseña a definir tus objetivos y establecer un plan de acción para conectarte con otros profesionales. Esto implica identificar a las personas adecuadas para conocer, decidir tanto el medio como el momento adecuados para darles alcance, y desarrollar una estrategia para mantener una comunicación efectiva y constante con ellos.',
    descriptionLong3: 'En segundo lugar, nuestra Guía de Búsqueda de Empleo también te proporciona consejos sobre cómo participar en eventos de networking, tanto en línea como en persona. Esto implica identificar los eventos adecuados para asistir, aprovechar al máximo tu tiempo en estos eventos y tener preparada una presentación breve, directa y efectiva para ti. Finalmente, nuestra Guía de Búsqueda de Empleo te enseña a mantener tu red de contactos activa y en constante crecimiento. Esto implica seguir en contacto con los profesionales con los que te has conectado, agregar nuevos contactos a tu red y buscar ocasiones para brindar información útil y apoyar a otros profesionales. Con estos consejos, podrás generar una red de contactos duradera y efectiva que te ayudará en la búsqueda de empleo y en tu desarrollo profesional.',
  }, 
  {
    idService: '6',
